...
# Poker hands 牌手: Straight flush 同花顺, Four of a kind 炸弹, 
# Flush 同花, Straight 顺子, Three of a kind 三带二, Full House 三带对,
# Two pair 两对, One pair 一对, High card 散牌
# straight flush : 同花大顺
...
def hand_rank(hand):
    ...
    if straight(ranks) and flush(hand):            # straight flush
        ...
        return (1, card_ranks(ranks), ranks)# your code here
    else:                                          # high card
